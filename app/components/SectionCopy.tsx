...
export default function SectionCopy({
  ...
  titleClass?: string;
  /** The hero of a page passes "h1"; every other section stays an "h2". */
  as?: "h1" | "h2";
}) {
  return (
    <div className="relative z-10 mx-auto max-w-[620px] px-6 text-center md:max-w-[760px]">
      ...
      <Heading className={`text-[34px] font-black leading-[1.05] tracking-normal sm:text-[42px] md:text-[56px] ${titleClass}`}>{title}</Heading>

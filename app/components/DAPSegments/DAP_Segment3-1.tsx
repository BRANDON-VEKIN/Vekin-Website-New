                ...
                <div className="flex flex-col sm:flex-row items-center justify-between gap-6 border-b border-gray-100 pb-6">
                    <div>
                        <LocalizedText 
                            ...
                            en="Concept" 
                            th="แนวคิด" 
                            className="text-3xl md:text-6xl font-bold text-gray-900 mt-1" 
                        />
                    </div>
                    {/* Enlarged Right Side Image without background */}
                    <div className="relative h-24 w-24 md:h-28 md:w-28 flex-shrink-0 overflow-hidden bg-transparent p-2">
                        <img 
                            src="/VEKIN Resource all Product/VEKIN 4/Img1.png" 
